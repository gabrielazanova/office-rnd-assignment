...
//             console.log(postingMember.error)
//         }
//         else {
//             console.log("Members: " + postingMember.data)
//         }
//     };
            ...
            >
                ...
                <Modal.Body>
                    <Form noValidate validated={this.state.validated}>
                        <Form.Group className="mb-3" >
                            <Form.Label>Name *</Form.Label>
                            <Form.Control type="text" placeholder="Full Name..." required value={this.state.name} />
                            <Form.Control.Feedback type="invalid">
                                Please provide a name.
                            </Form.Control.Feedback>
                        </Form.Group>
                        <Row className="mb-3">
                            <Col>
                                <Form.Group>
                                    <Form.Label>Company *</Form.Label>
                                    <Form.Select aria-label="Default select example" required value={this.state.company}>
                                        <option defaultValue disabled value="">Select Company</option>
                                        <option value="5d81dcfcb18f3e0010f5040d">Assignment demo</option>
                                        <option value="5d837099d4809b00104883ac">Los Angeles Lakers</option>
                                        <option value="5d8374f9d4809b00104883ee">Chicago Bulls</option>
                            ...
                            <Col>
                                <Form.Group>
                                    <Form.Label>Location *</Form.Label>
                                    <Form.Select aria-label="Default select example" required value={this.state.location}>
                                        <option defaultValue disabled value="">Select Location</option>
                                        <option value="5d81dcfcb18f3e0010f50407">West coast</option>
                                        <option value="5d839686e59be52704c30fbb">East coast</option>
                                    </Form.Select>
                        ...
                        <Row className="mb-3">
                            <Col>
                                <Form.Group>
                                    <Form.Label>Email</Form.Label>
                                    <Form.Control type="email" name="email" placeholder="Contact Email..." value={this.state.email} />
                                </Form.Group>
                            </Col>
                            <Col>
                                <Form.Group>
